...
<html>
    ...
    <body class="qsnback" >
      ...
      <header>
        ...
        <div class="container">
            <div class="row">
                <h1><b><center>Put The Details For Question Papers</center></b></h1>
                <form action="qsn.php" method="post">
                    <div class="form-row">
                        
                        <div class="form-group  col-md-3">
                          <label for="int_sem">Internal/Semester</label>
                          <select class="form-control" id="int_sem" name="int_sem" required>
                                <option id="intern" style="color: black">Internal Papers</option>
                                <option id="sem" style="color: black">Semester Papers</option>
                          </select>
                        </div>
                        <div class="form-group  col-md-3">
        ...
        <br>
            <?php 
                ...
                if($temp!=0){
                    ...
                    if($int_sem=="Internal Papers"){
                        
                        
                $i=1;
                $r=0;
                    
                $table_con = "SElECT dept, p_code, internal_qsn from internal WHERE dept='$depart' AND p_code='$pcode' AND sem_no='$sem'";
                $result = mysqli_query($con, $table_con)or die($mysqli_error($con));
                $num = mysqli_num_rows($result);
                
                    }
                    else if($int_sem=="Semester Papers"){
                         $i=1;
                         $r=1;
                    
                             $table_con = "SElECT dept, p_code, sem_qsn from semester WHERE dept='$depart' AND p_code='$pcode' AND sem_no='$sem'";
                             $result = mysqli_query($con, $table_con)or die($mysqli_error($con));
                             $num = mysqli_num_rows($result);
                    }
        ...
        <?php } 
                    ...
                    {?>
    <center> <p style="color: blue;"><b>***No Question Paper Found***</b></p><br></center>
